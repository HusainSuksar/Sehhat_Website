"""
Production settings for Umoor Sehhat
"""
import os
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'umoor_sehhat_prod'),
        'USER': os.environ.get('DB_USER', 'umoor_sehhat_user'),
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': '/var/log/umoor_sehhat/django.log',
        ...
        'error_file': {
            'level': 'ERROR',
            'class': 'logging.handlers.RotatingFileHandler',
            'filename': '/var/log/umoor_sehhat/django_error.log',
            'maxBytes': 1024*1024*5,  # 5 MB
            'backupCount': 5,
            'formatter': 'verbose',
        },
...
USE_TZ = True
TIME_ZONE = 'Asia/Karachi'  # Adjust for your timezone
