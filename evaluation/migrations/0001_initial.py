    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question_type', models.CharField(choices=[('dropdown', 'Dropdown'), ('multiple_choice', 'Multiple Choice'), ('rating', 'Rating Scale'), ('text', 'Text Input'), ('boolean', 'Yes/No')], default='rating', max_length=20)),
